...
use crate::{error::ReviewError, instruction::MovieInstruction};
...
pub fn process_instruction(
    ...
    match instruction {
        MovieInstruction::AddMovieReview {
            ...
            title,
            description,
        } => add_movie_review(program_id, accounts, rating, title, description),
        MovieInstruction::UpdateMovieReview {
            rating,
            title,
            description,
        } => update_movie_review(program_id, accounts, rating, title, description),
...
pub fn update_movie_review(
    ...
    let update_len = MovieAccountState::get_account_size(title.clone(), description.clone());
    if update_len > 1000 {
        msg!("Data length is larger than 1000 bytes");
        return Err(ReviewError::InvalidDataLength.into());
    }
